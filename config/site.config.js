...
module.exports = {
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route', '/Private','/Private/Invoices','/Personal'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:manofdiamond09@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ManOfDiamond',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/realmanofdiamond',
    },
  ],
